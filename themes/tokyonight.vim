...
" call s:HL(group, foreground, backgroun, gui, guisp)
"
" E.g.:
...
" }}}
" junegunn/fzf.vim{{{
let g:fzf_colors = { 'fg': ['fg', 'Normal'], 'bg': ['bg', 'Normal'], 'hl': ['fg', 'Green'], 'fg+': ['fg', 'CursorLine', 'CursorColumn', 'Normal'], 'bg+': ['bg', 'CursorLine', 'CursorColumn'], 'hl+': ['fg', 'Green'], 'info': ['fg', 'Yellow'], 'prompt': ['fg', 'Red'], 'pointer': ['fg', 'Blue'], 'marker': ['fg', 'Blue'], 'spinner': ['fg', 'Yellow'], 'header': ['fg', 'Blue'] }
" }}}
" Shougo/denite.nvim{{{
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  " Definition
  let s:terminal = { 'black':    s:palette.black, 'red':      s:palette.red, 'yellow':   s:palette.yellow, 'green':    s:palette.green, 'cyan':     s:palette.orange, 'blue':     s:palette.blue, 'purple':   s:palette.purple, 'white':    s:palette.fg }
  " Implementation: {{{
  if !has('nvim')
    let g:terminal_ansi_colors = [s:terminal.black[0], s:terminal.red[0], s:terminal.green[0], s:terminal.yellow[0], s:terminal.blue[0], s:terminal.purple[0], s:terminal.cyan[0], s:terminal.white[0], s:terminal.black[0], s:terminal.red[0], s:terminal.green[0], s:terminal.yellow[0], s:terminal.blue[0], s:terminal.purple[0], s:terminal.cyan[0], s:terminal.white[0]]
  else
